...
function validate(data: ContactFormData): FormErrors {
  ...
  if (!data.name.trim()) {
    ...
    newErrors.name = 'Ad soyad en az 2 karakter olmali.'
  }
...
export default function ContactForm() {
  ...
  function handleChange(field: keyof ContactFormData, value: string) {
    ...
    // Kullanici duzeltirken ilgili hata mesajini temizle.
    // (Koşulsuz yaparsak stale closure riski azalir.)
